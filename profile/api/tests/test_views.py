...
def test_external_supplier_get(mock_get_supplier_profile,
                               mock_get_sso_id_from_request,
                               api_client,
                               sso_user):
...
@patch('profile.api.views.get_sso_id_from_request')
@patch('profile.api.views.get_supplier_profile')
def test_external_supplier_client_error(mock_get_supplier_profile,
                                        mock_get_sso_id_from_request,
                                        api_client,
                                        sso_user):
...
@patch('profile.api.views.get_sso_id_from_request')
def test_external_supplier_incorrect_bearer_token(mock_get_sso_id_from_request,
                                                  api_client,
                                                  sso_user):
