...
# SSO API USER
DIRECTORY_SSO_API_USER_BASE_URL = env.str('SSO_API_USER_BASE_URL', '')
DIRECTORY_SSO_API_USER_API_KEY = env.str('SSO_SIGNATURE_SECRET', '')
DIRECTORY_SSO_API_USER_SENDER_ID = env.str(
    'SSO_API_USER_SENDER_ID', ''
)
DIRECTORY_SSO_API_USER_DEFAULT_TIMEOUT = env.str(
    'SSO_API_USER_DEFAULT_TIMEOUT', 5
)
